...
const FreshJuice = () => {
  ...
  const fetchProducts = async () => {
    try {
      const response = await axios.get(
        // `http://localhost:5000/api/products/selected-menus`
         `http://localhost:5000/api/products/fooditems`
      ); // Change menuType as needed (e.g. frankies_rolls, anna_dishes)
  ...
  // Call to load products whenever the page is changed
  useEffect(() => {
    fetchProducts();
  }, [page]);
